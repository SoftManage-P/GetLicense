	...
	<body class="page">
		...
		<div class="head-page">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h1 class="title-page">Successful Booking</h1>
		...
		<div class="text text_bottom-m_no">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<br /><br />
							<h1 style="font-size:18px; color:black;">Thank you for your Booking. You will receive a confirmation email with the further details.</h1>					
