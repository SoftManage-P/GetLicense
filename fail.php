	...
	<body class="page">
		...
		<div class="head-page">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h1 class="title-page">Payment did not work properly</h1>
						<div class="breadcrumbs">
							<ul class="breadcrumbs__list">
								<li class="breadcrumbs__item">
									<a href="/" class="breadcrumbs__link">Home</a>
								</li>
								<li class="breadcrumbs__item">Payment did not work properly</li>
							</ul>
						</div>
					</div>
		...
		<div class="text text_bottom-m_no">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<br /><br />
							<h1 style="font-size:18px; color:black;">Something went wrong.</h1>
<h2>The Payment did not work properly or you chose to cancel it</h2>
<h2>Please try again using the Email we sent you</h2>					
