	...
	<body class="page">
		...
		<div class="text text_bottom-m_no">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 style="font-size:18px; color:black;">lorem lorem</h1>					
							
						
						</div>
					</div>
					
					<p align='center'><img src="assets/images/Greater_Manchester.gif"><br></p>
						<h1 align='center' style="font-size:25px; color:black;">Greater Manchester & United Kingdom UK</h1><br><br><br>
	 ...
	 <div class="dev">
			<div class="container">
				<div class="dev__item">
					<a href="/" class="dev__link">Copyright © 2017 - <?php echo date("Y"); ?> Get License Fast</a>
				</div>
			</div>
		</div>
	<script>
